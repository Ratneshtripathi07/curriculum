...
1. Read up on the concept of the prototype from the articles below.
   ...
   3. Refer to this article by Lydia Hallie to learn Prototypal Inheritance with visualization [Javascript Visualized: Prototypal Inheritance](https://dev.to/lydiahallie/javascript-visualized-prototypal-inheritance-47co)
