...
1. Read up on the concept of the prototype from the articles below.
   ...
   3. Refer to this article by Lydia Hallie to learn Prototypical Inheritance visually [JavaScript Visualized: Prototypal Inheritance](https://dev.to/lydiahallie/javascript-visualized-prototypal-inheritance-47co).
